...
from DashaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from DashaBot.__main__ import DATA_IMPORT
from DashaBot.modules.helper_funcs.chat_status import user_admin
from DashaBot.modules.helper_funcs.alternate import typing_action

# from DashaBot.modules.rules import get_rules
import DashaBot.modules.sql.rules_sql as rulessql

# from DashaBot.modules.sql import warns_sql as warnssql
import DashaBot.modules.sql.blacklist_sql as blacklistsql
from DashaBot.modules.sql import disable_sql as disabledsql

# from DashaBot.modules.sql import cust_filters_sql as filtersql
# import DashaBot.modules.sql.welcome_sql as welcsql
import DashaBot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("DashaBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("DashaBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `DashaBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("DashaBot{}.backup".format(chat_id))  # Cleaning file
...
__help__ = """
*Commands for Group Owner:*
- `/import`*:* Reply to the backup file for the group to import as much as possible
- `/export`*:* Export group data, which will be exported are: rules, notes (documents, images, music, video, audio, voice, text, text buttons)

*Note:*
- Files and photos can't be imported due to telegram restrictions
"""
