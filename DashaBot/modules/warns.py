...
from DashaBot.modules.helper_funcs.string_handling import split_quotes
from DashaBot.modules.log_channel import loggable
from DashaBot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Dasha's sticker
        keyboard = None
        log_reason = (
...
*Commands for Admins:*
- `/warn`*:* Warn a user
- `/dwarn`*:* Warn a user and delete the message
- `/resetwarn`*:* Reset the warns for a user
...
*Note:*
- Default warn limit is 3, change using /warnlimit command
"""
