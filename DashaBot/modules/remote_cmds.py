...
RBAN_HANDLER = CommandHandler("rban", rban, filters=CustomFilters.dev_filter)
RUNBAN_HANDLER = CommandHandler("runban", runban, filters=CustomFilters.dev_filter)
RKICK_HANDLER = CommandHandler("rkick", rkick, filters=CustomFilters.dev_filter)
RMUTE_HANDLER = CommandHandler("rmute", rmute, filters=CustomFilters.dev_filter)
RUNMUTE_HANDLER = CommandHandler("runmute", runmute, filters=CustomFilters.dev_filter)
