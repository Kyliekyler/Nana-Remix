...
import DashaBot.modules.sql.blacklist_sql as sql
from DashaBot import dispatcher, LOGGER
...
from DashaBot.modules.helper_funcs.extraction import extract_text
from DashaBot.modules.helper_funcs.misc import split_message
from DashaBot.modules.log_channel import loggable
from DashaBot.modules.warns import warn
...
- `/unblacklist`*:* Remove a trigger from the blacklist
...
*Notes:*
- Each line is considered one trigger, so using different lines will allow you to add multiple triggers
- Admins and approved members are not affected by blacklist
- `<sticker link>` can be `https://t.me/addstickers/<sticker>` or just `<sticker>` or reply to the sticker message
- For tban and tmute at blacklist action you should specify the time (i.e 5m, 1h, 2d, 3w)
"""
