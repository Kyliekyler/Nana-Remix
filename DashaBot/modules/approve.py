...
from DashaBot import dispatcher, DRAGONS
from DashaBot.modules.helper_funcs.extraction import extract_user
from telegram.ext import CallbackContext, run_async, CallbackQueryHandler
import DashaBot.modules.sql.approve_sql as sql
...
- `/approve`*:* Gives user approval therefore locks, blacklists, and antiflood won't be applied to them
- `/unapprove`*:* Remove user from approval list therefore they will now be subject to locks, blacklists, and antiflood again
