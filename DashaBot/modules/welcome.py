...
import DashaBot.modules.sql.welcome_sql as sql
import DashaBot
...
from DashaBot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from DashaBot.modules.helper_funcs.msg_types import get_welcome_type
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "My owner joined the group!", reply_to_message_id=reply
                )
                welcome_log = (
...
- `/welcome noformat`*:* Shows current welcome settings, without the formatting
