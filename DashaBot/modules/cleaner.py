...
from DashaBot import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from DashaBot.modules.sql import cleaner_sql as sql
...
- `/gignoreblue <word>`*:* globally ignores bluetext cleaning of saved word across Dasha.
