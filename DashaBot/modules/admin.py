...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    if user_member.status == "creator":
        message.reply_text("This person CREATED the chat, I can't demote group owner!")
        return
    ...
    try:
        ...
        message.reply_text(
            "I couldn't demote. I might not be an admin or the admin status was appointed by another"
            " user therefore I can't act upon them!"
        )
        return
...
def set_title(update: Update, context: CallbackContext):
    ...
    if user_member.status == "creator":
        message.reply_text(
            "This person CREATED the chat, I can't set custom title for group owner!"
        )
        return

    if user_member.status != "administrator":
        message.reply_text(
            "I can't set title for non-admins!\nPromote them first to set custom title!"
        )
        return
...
__help__ = """  
*Command for Anyone:*
- `/admins`*:* Gets admin list in the chat
...
- `/admincache`*:* Force refresh the admin list
"""
