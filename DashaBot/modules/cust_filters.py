...
from DashaBot import dispatcher, LOGGER, OWNER_ID
...
from DashaBot.modules.helper_funcs.misc import build_keyboard_parser
from DashaBot.modules.helper_funcs.msg_types import get_filter_type
from DashaBot.modules.helper_funcs.string_handling import (
    split_quotes,
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from DashaBot.modules.sql import cust_filters_sql as sql
...
*Commands for Admins:*
- `/filter`*:* Add filter to the chat
- `/stop`*:* Stop the filter

*Command for Group Owner:*
- `/removeallfilters`*:* Remove all chat filter at once

*Notes:*
- Filters also support markdown formatting
- Check /markdownhelp to know more about formatting
"""
